...
export class Pool {
    ...
    ListAccessiblePoolsForUser(userId: string, page: number = null, itemsPerPage: number = null, sortBy: string = null, sortDirection: string = null): any {
    ...
    ListPoolAllotmentsForPool(poolId: string, sortBy: string = null, sortDirection: string = null, page: number = null, itemsPerPage: number = null): any {
    ...
    ListPoolContactsByPoolId(poolId: string, page: number = null, itemsPerPage: number = null): any {
    ...
    ListPools(name: string = null, sortBy: string = null, sortDirection: string = null, page: number = null, itemsPerPage: number = null): any {
    ...
    ListTagsForPool(poolId: string, sortBy: string = null, sortDirection: string = null, page: number = null, itemsPerPage: number = null): any {
    ...
    CreatePoolContract(poolId: string, poolContractType: string, startDate: number, endDate: number, poolContractId: string = null): any {
    ...
    RemoveCustomerDisplayNameForPool(poolId: string): any {
        return this.restClient.post('Pool/UseCase/RemoveCustomerDisplayNameForPool', {
            poolId
        }    );
    }
    ...
    SendUpgradeRequestToCsm(poolId: string, userId: string, slackUserId: string = null, requestedFeatureSlugs: any = null, other: string = null): any {
    ...
    SetCustomerDisplayNameForPool(poolId: string, customerDisplayName: string): any {
    ...
    UpdatePoolContract(poolContractId: string, poolContractType: string = null, startDate: number = null, endDate: number = null): any {
