...
export class Invitation {
   ...
   * @param string[]? - withData UserHealthPass|Event|UserName|User|UserIdentifier|Stack|TicketType|QuestionResponse|Answer|Purchase|GuestPassAvailabilityCounts|EFxActivationStatus|RelatedInvitation
   ...
   * @return Promise|Observable|any
   */
  SetGuestPassCount(invitationId: string, guestPassCount: number = null): any {
    return this.restClient.post('Invitation/UseCase/SetGuestPassCount', {
      invitationId,
      guestPassCount,
    });
  }
