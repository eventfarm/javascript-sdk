...
export class User {
    ...
    // GET: Queries
    CheckIfUserCanBeRemovedFromPool(removeUserId: string, requestUserId: string, poolId: string): any {
    ...
    GetUserInPool(poolId: string, userId: string, withData: any = null, withUserAttributes: any = null): any {
    ...
    ListUsersForPools(poolIds: any, withData: any = null, query: string = null, sortBy: string = null, sortDirection: string = null, page: number = null, itemsPerPage: number = null): any {
    ...
    ListUsersForTicketBlock(ticketBlockId: string, withData: any = null, query: string = null, sortBy: string = null, sortDirection: string = null, page: number = null, itemsPerPage: number = null): any {
    ...
    ListUsersInGroup(groupId: string, poolId: string, withData: any = null, query: string = null, sortBy: string = null, sortDirection: string = null, page: number = null, itemsPerPage: number = null): any {
    ...
    ListUsersWithRolesForEvent(eventId: string, withData: any = null, query: string = null, sortBy: string = null, sortDirection: string = null, page: number = null, itemsPerPage: number = null): any {
    ...
    CreateUser(email: string = null, firstName: string = null, lastName: string = null, company: string = null, position: string = null, phone: string = null, poolId: string = null, title: string = null, other: string = null): any {
    ...
    CreateUserContactAgent(userId: string, poolId: string, email: string, userContactAgentId: string = null): any {
    ...
    RemoveUsersFromPool(removeUserIds: any, requestUserId: string, poolId: string): any {
    ...
    SetEmailForInvitation(invitationId: string, authUserId: string, changeUserId: string, email: string): any {
    ...
    SetEventRoleForUser(userId: string, eventId: string, eventRole: string, authenticatedUserId: string): any {
