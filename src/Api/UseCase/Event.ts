...
export class Event {
   ...
   * @param string[]? - withData Pool|Stacks|StacksWithAvailabilityCounts|Tags|EventTexts|TicketTypes|TicketBlocks|TicketBlocksWithAllotmentCounts|QuestionsAndAnswers|QuestionContext|AllQuestions|ParentEvent|PoolFeatures|EventTheme|VirbelaWorld|AnswerBindings|EventLinks|AirshipAdaptiveLink
   * @return Promise|Observable|any
   */
   ...
   * @param string - poolId
   * @param string - userId
   * @param string - variant session|panel|keynote|block|sample|breakout
   * @param string - eventName
   * @param string - parentEventId
   * @param string - description
   ...
   * @return Promise|Observable|any
   */
  DisableKioskModeBreakoutSessionsEnabledForEvent(eventId: string): any {
    return this.restClient.post(
      'Event/UseCase/DisableKioskModeBreakoutSessionsEnabledForEvent',
      {
        eventId,
      },
    );
  ...
  /**
   * @param string - eventId
   * @param string - eventVariant full|cio|lite|session|panel|keynote|block|sample|breakout
   * @return Promise|Observable|any
   */
