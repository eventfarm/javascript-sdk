...
export class Promotion {
    ...
    CreatePromotion(eventId: string, promotionType: string, code: string, startTime: number, endTime: number, amount: number, used: number, maximum: number, message: string, isEnabled: boolean = null, promotionId: string = null): any {
