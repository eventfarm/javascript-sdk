...
export class EFx {
  ...
  /**
   * @param string - eventId
   * @param string - moduleType guest-management|access-control|athletes-bag|concierge|digital-memory-bank|guest-info|messaging|smsquiz|product-pickup|raffle|reservation|roaming-photographer|smart-bar|teams
   * @return Promise|Observable|any
   */
   ...
   * @param string - eventId
   * @param string - userId
   * @param any[]? - requestedEFxModules guest-management|access-control|athletes-bag|concierge|digital-memory-bank|guest-info|messaging|smsquiz|product-pickup|raffle|reservation|roaming-photographer|smart-bar|teams
   * @return Promise|Observable|any
   */
  RequestForEvent(
    eventId: string,
