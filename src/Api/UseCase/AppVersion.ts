...
export class AppVersion {
  ...
  /**
   * @param string - appVersionType check-in-ios|check-in-android|ticket-block-mgmt-ios|ticket-block-mgmt-android|efx-ios|efx-android|events-ios|events-android|leads-flutter|wakanda
   * @return Promise|Observable|any
   */
