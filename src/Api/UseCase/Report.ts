...
export class Report {
    ...
    CreateAdminEventReport(eventId: string, ownerUserId: string, name: string = null): any {
    ...
    CreateConfirmedGuestReport(eventId: string, ownerUserId: string, name: string = null): any {
    ...
    CreateEmailDeliverabilityReport(eventId: string, ownerUserId: string, name: string): any {
        return this.restClient.post('Report/UseCase/CreateEmailDeliverabilityReport', {
            eventId,
            ownerUserId,
            name
        }    );
    ...
    CreateGraphicalCheckinReport(eventId: string, ownerUserId: string, name: string): any {
    ...
    CreateGuestSummaryReport(eventId: string, ownerUserId: string, name: string): any {
    ...
    CreatePurchasedReport(eventId: string, ownerUserId: string, name: string): any {
    ...
    CreateSentEmailReport(eventId: string, ownerUserId: string, name: string): any {
    ...
    CreateTicketBlockSummaryReport(eventId: string, ownerUserId: string, ticketBlockId: string, name: string): any {
    ...
    CreateTicketBlockUserReport(eventId: string, ownerUserId: string, name: string): any {
    ...
    CreateTransferReport(eventId: string, ownerUserId: string, name: string): any {
    ...
    CreateUnconfirmedGuestReport(eventId: string, ownerUserId: string, name: string): any {
    ...
    CreateWaitListReport(eventId: string, ownerUserId: string, name: string): any {
